<?php
$page_title = "Our Programs & Key Initiatives - Matri Seva Samiti";
    ...
    <section class="page-hero">
        ...
        <div class="container">
            <div class="breadcrumb">
                <a href="index.php">Home</a> <span>/</span> <span>Programs</span>
            </div>
            <h1>Our Core <span class="highlight">Programs</span></h1>
            <p>Empowering rural communities through sustainable interventions in education, health, skills, and livelihood.</p>
        </div>
    </section>
    ...
    <section style="padding: 80px 0; background: var(--bg-slate);">
        <div class="container">
            <div class="section-header">
                <div class="section-tag"><i class="fas fa-layer-group"></i> Sustainable Interventions</div>
                <h2>Grassroots Development Programs</h2>
                <p>Each program is carefully designed with community participation to deliver measurable and long-lasting positive transformation.</p>
            </div>
            ...
            <div class="programs-container">
                ...
                <div class="program-card-detail">
                    ...
                    <div class="program-content-side">
                        ...
                        <div class="program-field">
                            ...
                            <p>To ensure inclusive, equitable, and quality education while promoting digital literacy, foundational numeracy, life skills, and personality development among children from underprivileged rural families.</p>
                        </div>
                        <div class="program-field">
                            <strong>Key Activities:</strong>
                            <ul class="program-activities-grid">
                                <li><i class="fas fa-check-circle"></i> Free Remedial Learning Centers</li>
                                <li><i class="fas fa-check-circle"></i> School Enrolment & Anti-Dropout Drives</li>
                        ...
                        <div class="program-field">
                            ...
                            <span class="badge badge-navy">School Children</span>
                            <span class="badge badge-navy">Adolescent Girls</span>
                            <span class="badge badge-navy">Dropout Students</span>
                        </div>
                        <div class="program-actions">
                            <a href="donate.php?cause=education" class="btn btn-primary btn-sm"><i class="fas fa-heart"></i> Sponsor a Child's Education</a>
                            <a href="volunteer.php?role=education" class="btn btn-secondary btn-sm"><i class="fas fa-chalkboard-teacher"></i> Volunteer as Teacher</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="program-card-detail">
                    ...
                    <div class="program-content-side">
                        ...
                        <div class="program-field">
                            <strong>Objective:</strong>
                            <p>To empower women socially, economically, and legally through self-help group (SHG) mobilization, micro-enterprise training, financial literacy, and gender rights awareness.</p>
                        </div>
                        <div class="program-field">
                            <strong>Key Activities:</strong>
                            <ul class="program-activities-grid">
                        ...
                        <div class="program-field">
                            <strong>Target Beneficiaries:</strong>
                            <span class="badge badge-navy">Rural Women</span>
                            <span class="badge badge-navy">SHG Members</span>
                            <span class="badge badge-navy">Homemakers</span>
                        </div>
                        <div class="program-actions">
                            <a href="donate.php?cause=women" class="btn btn-primary btn-sm"><i class="fas fa-heart"></i> Support Women Entrepreneurs</a>
                            <a href="volunteer.php?role=women" class="btn btn-secondary btn-sm"><i class="fas fa-hands-helping"></i> Mentor a SHG</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="program-card-detail">
                    ...
                    <div class="program-content-side">
                        ...
                        <div class="program-field">
                            <strong>Target Beneficiaries:</strong>
                            <span class="badge badge-navy">Rural Families</span>
                            <span class="badge badge-navy">Expectant Mothers</span>
                            <span class="badge badge-navy">Senior Citizens</span>
                        </div>
                        <div class="program-actions">
                            <a href="donate.php?cause=health" class="btn btn-primary btn-sm"><i class="fas fa-heart"></i> Fund a Rural Health Camp</a>
                            <a href="volunteer.php?role=health" class="btn btn-secondary btn-sm"><i class="fas fa-user-md"></i> Volunteer as Doctor/Nurse</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="program-card-detail">
                    ...
                    <div class="program-content-side">
                        ...
                        <div class="program-field">
                            <strong>Target Beneficiaries:</strong>
                            <span class="badge badge-navy">Unemployed Youth</span>
                            <span class="badge badge-navy">High School Graduates</span>
                            <span class="badge badge-navy">Rural Artisans</span>
                        </div>
                        <div class="program-actions">
                            <a href="donate.php?cause=skill" class="btn btn-primary btn-sm"><i class="fas fa-heart"></i> Sponsor a Youth's Vocational Course</a>
                            <a href="volunteer.php?role=trainer" class="btn btn-secondary btn-sm"><i class="fas fa-laptop-code"></i> Volunteer as Skill Trainer</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="cta-banner-content">
                ...
                <div class="cta-banner-buttons">
                    <a href="grants.php" class="btn btn-primary btn-lg"><i class="fas fa-handshake"></i> CSR Collaboration</a>
                    <a href="contact.php" class="btn btn-outline btn-lg"><i class="fas fa-envelope"></i> Contact Program Team</a>
                </div>
            </div>
        </div>
    </section>
