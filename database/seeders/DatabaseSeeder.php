    ...
    public function run(): void
    {
        ...
        $programs = [
            [
                ...
                'slug' => 'education-digital-literacy',
                'category' => 'Education',
                'icon' => 'flaticon-graduation-cap',
                'image' => 'images/student1.jpeg',
                'short_description' => 'Remedial tutoring, digital tablets, school supplies, and merit-based sponsorships for rural children.',
            ...
            [
                'title' => 'Healthcare, Nutrition & Hygiene',
                'slug' => 'healthcare-nutrition-hygiene',
                'category' => 'Health',
                'icon' => 'flaticon-healthcare',
                'image' => 'images/project1.jpeg',
                'short_description' => 'Mobile medical clinics, maternal-child nutrition drives, and menstrual hygiene awareness programs.',
                'description' => 'Ensuring accessible basic healthcare and preventive health awareness across underserved communities.',
                'sort_order' => 2,
                'is_active' => true,
            ],
            [
                'title' => 'Women Empowerment & Self-Help Groups',
                'slug' => 'women-empowerment-shg',
                'category' => 'Livelihood',
                'icon' => 'flaticon-love',
                'image' => 'images/student2.jpeg',
                'short_description' => 'Micro-enterprise incubation, tailoring clusters, handicraft promotion, and financial literacy workshops.',
                'description' => 'Catalyzing grassroots leadership and financial self-sufficiency for rural women.',
                'sort_order' => 3,
                'is_active' => true,
            ],
            [
                'title' => 'Environment & Sustainable Agriculture',
                'slug' => 'environment-sustainable-agriculture',
                'category' => 'Environment',
                'icon' => 'flaticon-tree',
                'image' => 'images/student3.jpeg',
                'short_description' => 'Tree plantation drives, organic farming techniques, rainwater harvesting, and solar energy adoption.',
                'description' => 'Promoting ecological resilience and climate-smart agricultural practices among smallholder farmers.',
                'sort_order' => 4,
                'is_active' => true,
            ]
        ];
