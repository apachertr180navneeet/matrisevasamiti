...
<main>
    ...
    <section class="ul-breadcrumb ul-section-spacing">
        <div class="ul-container">
            <h2 class="ul-breadcrumb-title">About Matri Seva Samiti</h2>
            ...
            <div class="row row-cols-md-2 row-cols-1 align-items-center gy-4 ul-about-row">
                <div class="col">
                    <div class="ul-about-imgs">
                        <div class="img-wrapper" style="border-radius: 20px; overflow: hidden; box-shadow: 0 10px 30px rgba(0,0,0,0.15);">
                            <img src="{{ asset('images/about-us.jpg') }}" alt="About Matri Seva Samiti" style="width: 100%; height: auto; object-fit: cover;">
                        </div>
                ...
                <div class="col">
                    <div class="ul-about-txt">
                        ...
                        <p class="ul-section-descr">Matri Seva Samiti was established in <strong>April {{ config('site.org_established') }}</strong>, inspired by Mahatma Gandhi's vision that "real India is in villages." Founded by visionary leader <strong>{{ config('site.org_owner') }}</strong>, our organization has been dedicated to transforming rural communities through sustainable development programs.</p>
                        ...
                        <div class="ul-about-block">
                            ...
                            <div class="block-right"><img src="{{ asset('images/president.png') }}" alt="Founder President" style="width: 120px; height: 120px; border-radius: 12px; object-fit: cover;"></div>
                        </div>
            ...
            <div class="row row-cols-lg-3 row-cols-md-2 row-cols-1 gy-4">
                ...
                <div class="col">
                    <div class="card p-4 border-0 shadow-sm rounded-4 h-100 text-center">
                        ...
                        <p class="text-muted">{{ config('site.org_mission') }}</p>
                    </div>
                </div>
        ...
        <div class="ul-container">
            ...
            <div class="row row-cols-lg-4 row-cols-md-2 row-cols-sm-2 row-cols-1 gy-4 justify-content-center mb-5">
                ...
                <div class="col">
                    <div class="ul-team-member text-center">
                        <div class="ul-team-member-img">
                            <img src="{{ asset('images/president.png') }}" alt="Gyan Shankar Pal" style="height: 280px; width: 100%; object-fit: cover; border-radius: 15px;">
                        </div>
                ...
                <div class="col">
                    <div class="ul-team-member text-center">
                        <div class="ul-team-member-img">
                            <img src="{{ asset('members/dheeraj-raj-pal.jpeg') }}" alt="Dheeraj Raj Pal" style="height: 280px; width: 100%; object-fit: cover; border-radius: 15px;">
                        </div>
                        <div class="ul-team-member-info mt-3">
                ...
                <div class="col">
                    <div class="ul-team-member text-center">
                        <div class="ul-team-member-img">
                            <img src="{{ asset('members/narendra-nath-pal.jpeg') }}" alt="Narendra Nath Pal" style="height: 280px; width: 100%; object-fit: cover; border-radius: 15px;">
                        </div>
                        <div class="ul-team-member-info mt-3">
                ...
                <div class="col">
                    <div class="ul-team-member text-center">
                        <div class="ul-team-member-img">
                            <img src="{{ asset('members/mamta-pal.jpeg') }}" alt="Mamta Pal" style="height: 280px; width: 100%; object-fit: cover; border-radius: 15px;">
                        </div>
                        <div class="ul-team-member-info mt-3">
            ...
            <div class="row row-cols-lg-3 row-cols-md-3 row-cols-sm-2 row-cols-1 gy-4 justify-content-center">
                ...
                <div class="col">
                    <div class="ul-team-member text-center">
                        <div class="ul-team-member-img">
                            <img src="{{ asset('members/priyanka-pal.jpeg') }}" alt="Priyanka Pal" style="height: 280px; width: 100%; object-fit: cover; border-radius: 15px;">
                        </div>
                        <div class="ul-team-member-info mt-3">
                ...
                <div class="col">
                    <div class="ul-team-member text-center">
                        <div class="ul-team-member-img">
                            <img src="{{ asset('members/sadhana-pal.jpeg') }}" alt="Sadhana Pal" style="height: 280px; width: 100%; object-fit: cover; border-radius: 15px;">
                        </div>
                        <div class="ul-team-member-info mt-3">
                ...
                <div class="col">
                    <div class="ul-team-member text-center">
                        <div class="ul-team-member-img">
                            <img src="{{ asset('members/sumitra-pal.jpeg') }}" alt="Sumitra Pal" style="height: 280px; width: 100%; object-fit: cover; border-radius: 15px;">
                        </div>
                        <div class="ul-team-member-info mt-3">
