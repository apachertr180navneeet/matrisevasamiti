                ...
                <div class="col">
                    <div class="card p-4 p-md-5 border-0 shadow rounded-4 text-white" style="background: linear-gradient(135deg, #0F2B5B 0%, #1a3f7a 100%);">
                        ...
                        <div class="d-flex gap-3">
                            <a href="{{ route('donate.index') }}" class="btn btn-warning rounded-pill px-4 font-bold">Donate Now &rarr;</a>
                            <a href="{{ route('volunteer.index') }}" class="btn btn-outline-light rounded-pill px-4">Join as Volunteer</a>
                        </div>
                    </div>
                </div>
            </div>
