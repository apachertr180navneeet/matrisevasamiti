            ...
            <div class="row row-cols-lg-3 row-cols-md-2 row-cols-1 gy-4">
                ...
                <div class="col">
                    <div class="card border-0 shadow-sm rounded-4 overflow-hidden h-100">
                        <img src="{{ asset('images/education-initiative-news.jpg') }}" alt="Dainik Jagran Coverage" class="img-fluid" style="height:220px; object-fit:cover;">
                ...
                <div class="col">
                    <div class="card border-0 shadow-sm rounded-4 overflow-hidden h-100">
                        <img src="{{ asset('images/healthcare-camp-news.jpg') }}" alt="Amar Ujala Feature" class="img-fluid" style="height:220px; object-fit:cover;">
                        <div class="p-4 d-flex flex-column flex-grow-1">
                ...
                <div class="col">
                    <div class="card border-0 shadow-sm rounded-4 overflow-hidden h-100">
                        <img src="{{ asset('images/women-empowerment-news.jpg') }}" alt="The Hindu Social Impact" class="img-fluid" style="height:220px; object-fit:cover;">
                        <div class="p-4 d-flex flex-column flex-grow-1">
                            ...
                            <span class="text-muted mt-auto" style="font-size:12px;"><i class="flaticon-calendar me-1"></i> Published: May {{ date('Y') }}</span>
                        </div>
                    </div>
                </div>
            </div>
