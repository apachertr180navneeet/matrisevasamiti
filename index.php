<?php 
$page_title = "Matri Seva Samiti - For The People & Cause You Care About";
            ...
            <div class="row gy-4 row-cols-lg-2 row-cols-1 align-items-center flex-column-reverse flex-lg-row">
                ...
                <div class="col">
                    <div class="ul-banner-txt">
                        ...
                        <img src="assets/img/vector-img.png" alt="Vector Art" class="ul-banner-txt-vector">
                    </div>
                </div>
                ...
                <div class="col">
                    <div class="ul-about-imgs">
                        ...
                        <div class="ul-about-imgs-vectors">
                            ...
                            <img src="assets/img/about-img-vector-2.svg" alt="Decoration" class="vector-2">
                        </div>
                    </div>
                </div>
            ...
            <div class="ul-section-heading ul-donations-heading justify-content-between text-center">
                ...
                <div class="flex-shrink-0">
                    <div class="ul-banner-stat">
                        <div class="imgs">
                            <img src="assets/img/user-1.png" alt="Donor">
                            <img src="assets/img/user-3.png" alt="Donor">
                            <img src="assets/img/user-2.png" alt="Donor">
                            <span class="number">15K+</span>
                        </div>
    ...
    <section class="ul-events ul-section-spacing pt-0">
        <div class="ul-container">
            <div class="ul-section-heading align-items-center wow animate__fadeInUp">
                ...
                <a href="volunteer.php" class="ul-btn"><i class="flaticon-fast-forward-double-right-arrows-symbol"></i> Join An Event</a>
            </div>
        ...
        <div class="ul-events-vectors">
            <img src="assets/img/events-vector-1.png" alt="Vector" class="vector-1">
            <img src="assets/img/events-vector-2.svg" alt="Vector" class="vector-2">
        </div>
    </section>
    <!-- EVENTS SECTION END -->
    ...
    <section class="ul-team ul-section-spacing pt-0">
        <div class="ul-container">
            <div class="ul-section-heading justify-content-between">
                ...
                <div>
                    <a href="volunteer.php" class="ul-btn"><i class="flaticon-fast-forward-double-right-arrows-symbol"></i> Join MSS</a>
                </div>
            </div>
                ...
                <div class="col-sm-7">
                    <div class="ul-blogs-slider swiper">
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide">
                                <div class="ul-blog">
                                    <div class="ul-blog-img"><img src="assets/img/blog-1.jpg" alt="Child Education">
                                        <div class="date">
                                    ...
                                    <div class="ul-blog-txt">
                                        ...
                                        <a href="blogs.php" class="ul-blog-title">Giving Education: The Greatest Gift For A Child's Future</a>
                                        <a href="blogs.php" class="ul-blog-btn">Read More <span class="icon"><i class="flaticon-next"></i></span></a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="swiper-slide">
                                <div class="ul-blog">
                                    <div class="ul-blog-img"><img src="assets/img/blog-2.jpg" alt="Healthcare Camp">
                                        <div class="date">
                                    ...
                                    <div class="ul-blog-txt">
                                        ...
                                        <a href="blogs.php" class="ul-blog-title">Overcoming Medical Inaccessibility in Remote Villages</a>
                                        <a href="blogs.php" class="ul-blog-btn">Read More <span class="icon"><i class="flaticon-next"></i></span></a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="swiper-slide">
                                <div class="ul-blog">
                                    <div class="ul-blog-img"><img src="assets/img/blog-3.jpg" alt="Women Skill Center">
                                        <div class="date">
                                    ...
                                    <div class="ul-blog-txt">
                                        ...
                                        <a href="blogs.php" class="ul-blog-title">How Micro-Enterprises Empower Rural Women Financially</a>
                                        <a href="blogs.php" class="ul-blog-btn">Read More <span class="icon"><i class="flaticon-next"></i></span></a>
                                    </div>
                                </div>
                            </div>
